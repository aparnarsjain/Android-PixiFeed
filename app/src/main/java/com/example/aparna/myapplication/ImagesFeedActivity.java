...
public class ImagesFeedActivity extends AppCompatActivity {
...
//                        photo.type = photoJSON.getJSONObject("type").toString();
                        photos.add(photo);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_images_feed, menu);
        return true;
    }
